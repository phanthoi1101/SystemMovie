    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="XoaSuaKhachHangController" method="post">
                ...
                <p class="form-control"><%=kh.getTenKhachHang() %></p>
            </div>

                <!-- Contact Name -->
                <div class="mb-3">
                    <label class="form-label">Email:</label>
                    <p class="form-control"><%=kh.getEmail() %></p>
                </div>

                <!-- Phone -->
                <div class="mb-3">
                    <label for="Phone" class="form-label">Điện thoại:</label>
                    <p class="form-control"><%=kh.getSoDienThoai() %></p>
                </div>

                <!-- Email -->
                <div class="mt-3 mb-3">
	                <label for="datepicker" class="form-label">Ngày sinh:</label>
	                <p class="form-control"><%=kh.getNgaySinh() %></p>
            	</div>

                <!-- Address -->
                <div class="mb-3">
                    <label class="form-label">Giới tính:</label>
	                <p class="form-control"><%=kh.isGioiTinh()?"Nam":"Nữ" %></p>
                </div>
				<div class="mb-3">
                    <label for="Phone" class="form-label">Địa chỉ:</label>
                    <p class="form-control"><%=kh.getDiaChi() %></p>
                </div>
                <div class="mb-3">
                    <label for="Phone" class="form-label">Tên đăng nhập:</label>
                    <p class="form-control"><%=kh.getTenDangNhap() %></p>
                </div>

                <!-- Buttons -->
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-danger me-2" name="XacNhanXoa">
