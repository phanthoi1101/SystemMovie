...
<body>
    ...
    <form action="XoaSuaLichChieuController" method="post">
            ...
            <div class="mt-3 mb-3">
                ...
                %>
                	<p class="form-control"><%=phongchieu.getTenPhongChieu() %></p>
                <%}
                	} %>
            </div>
            <div class="mt-3 mb-3">
                <label class="form-label">Ngày Chiếu</label>
                <p class="form-control"><%=lichChieu.getNgayChieu() %></p>
            </div>
            <div class="mt-3 mb-3">
            ...
            <div class="form-group text-right">
                <button  type="submit" name="DeleteLichChieu" value="" class="btn btn-danger">
