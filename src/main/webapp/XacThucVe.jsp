...
<%ArrayList<LichSuDatVe> ds = (ArrayList<LichSuDatVe>)session.getAttribute("VeChuaThanhToan"); 
ArrayList<KhachHang> dskh = (ArrayList<KhachHang>)session.getAttribute("dsKhachHang");
%>
<div class="container">
		<div class="row">
		...
		<div class="text-center">
			<h3 class="text-danger">Không có vé để thanh toán</h3>
		</div>
		<%}else{ %>
		      ...
		      <tbody>    	
				<%for(int i = 0 ; i < ds.size() ; i++){ %>					
			     	<tr>
				        ...
				        if(kh.getMaKhachHang()==ds.get(i).getMaKhachHang()){
				        %>
				        	<td><% %>
				        <%=kh.getTenKhachHang() %></td>
				        <%} }%>
				        ...
				        <form action="XacThucVeController" method="post">	
				        <input type="hidden" name="MaVe" value="<%=ds.get(i).getMaVe() %>" />
				        <td><button type="submit" class="btn btn-sm btn-primary me-2" name="buttonThanhToan" value="">
