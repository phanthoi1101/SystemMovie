...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Bổ sung lịch chiếu</title>
...
<body>
    ...
    <div class="mt-4 mb-4 text-center"><h3>Bổ sung lịch chiếu</h3></div>
		  ...
		  <div class="mb-3 mt-3">
           ...
           <div class="mb-3 mt-3">
            ...
            <div class="mt-3 mb-3">
                ...
                <input type="" class="form-control" name="GioChieu" />
            </div>
            <!-- bổ sung -->
            <div class="form-group text-right">
                <button  type="submit" name="ThemLichChieu" value="" class="btn btn-primary">
